...
#+begin_src latex
  ...
  default x11 window, and set the width and height of the plot in
  cm. The user can also ask for the R script instead of the plot.
#+end_src
...
#+begin_src latex
  ...
  and the names of the files for postscript and R output.
#+end_src
