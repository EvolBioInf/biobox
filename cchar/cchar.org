...
#+begin_src latex
  ...
  its version.
#+end_src
#+begin_src go <<Parse options, Ch.~\ref{ch:cch}>>=
  flag.Parse()
  if *optV {
...
#+end_src
#+begin_src go <<Parse input, Ch.~\ref{ch:cch}>>=
  files := flag.Args()
...
#+begin_src go <<Functions, Ch.~\ref{ch:cch}>>=
  func scan(r io.Reader, args ...interface{}) {
	  //<<Retrieve arguments, Ch.~\ref{ch:cch}>>
...
#+end_src
#+begin_src go <<Retrieve arguments, Ch.~\ref{ch:cch}>>=
  counts := args[0].([]int64)
...
#+begin_src go <<Functions, Ch.~\ref{ch:cch}>>=
  func write(counts []int64, separate bool) {
	  //<<Print total character count, Ch.~\ref{ch:cch}>>
...
#+begin_src latex
  ...
  or ``total'' mode.
#+end_src
#+begin_src go <<Print total character count, Ch.~\ref{ch:cch}>>=
  var s int64
...
#+end_src
#+begin_src go <<cchar_test.go>>=
  package main
  import (
	  "testing"
	  //<<Testing imports, Ch.~\ref{ch:cch}>>
  )
  func TestCchar(t *testing.T) {
	  //<<Testing, Ch.~\ref{ch:cch}>>
  }
#+end_src
#+begin_src latex
...
#+end_src
#+begin_src go <<Testing, Ch.~\ref{ch:cch}>>=
...
#+end_src
#+begin_src go <<Testing imports, Ch.~\ref{ch:cch}>>=
  "os/exec"
  "io/ioutil"
  "bytes"
#+end_src
