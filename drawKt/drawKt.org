...
#+end_src
#+begin_src latex
  Apart from the default help, there are three options, the user can
  request a \LaTeX{} wrapper, plain text instead of \LaTeX{}, and the
  program version.
#+end_src
...
#+end_src
#+begin_src latex
  We write brief \LaTeX{} code to wrapper file and close it again.
#+end_src
