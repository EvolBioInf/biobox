...
#+end_src
#+begin_src latex
  We import \ty{io}, \ty{newick}, and \ty{fmt}.
#+end_src
#+begin_src go <<Imports, Ch.~\ref{ch:tt}>>=
  "io"
...
#+end_src
#+begin_src go <<Functions, Ch.~\ref{ch:tt}>>=
  func inorder(v *newick.Node, w *tabwriter.Writer) {
	  if v == nil { return }
	  inorder(v.Child, w)
...
#+end_src
#+begin_src go <<Functions, Ch.~\ref{ch:tt}>>=
  func postorder(v *newick.Node, w *tabwriter.Writer) {
	  if v == nil { return }
	  postorder(v.Child, w)
	  postorder(v.Sib, w)
	  //<<Determine node type, Ch.~\ref{ch:tt}>>
...
#+end_src
#+begin_src go <<Functions, Ch.~\ref{ch:tt}>>=
  func preorder(v *newick.Node, w *tabwriter.Writer) {
	  if v == nil { return }
	  //<<Determine node type, Ch.~\ref{ch:tt}>>
	  //<<Print row in node table, Ch.~\ref{ch:tt}>>
	  preorder(v.Child, w)
